...
(function(a) {
  var e = function(d, c) {
      ...
      a("<img/>").attr("src", f).load(function() {
          g ? b.attr("src", a(this).attr("src")) : (b.backgroundImageUrl(a(this).attr("src")),
...
!function(t, e) {
  ...
  t.widget("kf.wizard", {
      ...
      _create: function() {
          var e, i, d = this, l = d.options, c = d.element, h = c.find(l.steps).eq(0).parent();
      ...
      _fastForward: function(s, n, r) {
          ...
          function e() {
              a._transition(o, function(l, c) {
                  if (-1 === (o = a.stepIndex(l, c)))
                      throw new Error('[_fastForward]: Invalid step "' + l + '"');
                  if (t.inArray(o, d) >= 0)
                      throw new Error('[_fastForward]: Recursion detected on step "' + l + '"');
                  d.push(o),
                  o === a._lastStepIndex || (n ? ++i : o) === s ? r.call(a, o, d) : e()
              })
          }()
      },
      _find: function(e, s, n) {
          var r, i, o, l, c, h = [], p = s instanceof jQuery ? s : t(s);
          if (null !== e && p.length)
              for (i = 0,
              o = (e = a(e)).length; i < o; i++)
                  r = null,
                  (c = typeof (l = e[i])) === d ? r = p.get(l) : "string" === c ? r = document.getElementById(l.replace("#", "")) : "object" === c && (l instanceof jQuery && l.length && (l = l[0]),
                  l.nodeType && p.each(function(t, e) {
                      if (e === l)
                          return r = e,
                          !1
                  })),
      ...
      _state: function(e, s) {
          ...
          for (var i, o, d, l = 0, c = s.length; l < c; l++)
              ...
              !r.stepIndex || r.stepIndex < e ? t.inArray(e, r.stepsActivated) < 0 && (r.stepsActivated.push(e),
              t.inArray(i, r.branchesActivated) < 0 && r.branchesActivated.push(i)) : r.stepIndex > e && (o = t.inArray(i, r.branchesActivated) + 1,
              ...
              r.stepIndex = e,
              r.branchLabel = i;
          return r.stepsComplete = Math.max(0, this._find(r.stepsActivated, this.elements.steps).filter(this._excludesFilter).length - 1),
      ...
      _transition: function(s, n, r) {
          var d = this;
          t.isFunction(s) ? (r = s,
          s = d._currentState.stepIndex,
          n = e) : t.isFunction(n) && (r = n,
          n = e);
          var l, c = d.options, h = d.step(s, n), p = h.attr(c.stateAttribute), u = p ? c.transitions[p] : c.transitions[o];
          return (l = t.isFunction(u) ? u.call(d, h, function() {
              return r.apply(d, i.call(arguments))
          }) : p) !== e && !1 !== l && r.apply(d, a(l)),
          l
      },
      _update: function(e, s) {
          var n = this._currentState
            , r = this.options;
          if (n.step) {
              if (r.disabled || !s || s.stepIndex === n.stepIndex || !this._trigger("beforeSelect", e, s) || s.isMovingForward && !this._trigger("beforeForward", e, s) || !s.isMovingForward && !this._trigger("beforeBackward", e, s))
                  return;
          ...
          n.step && (this._trigger("afterSelect", e, s),
          this._trigger(s.isMovingForward ? "afterForward" : "afterBackward", e, s))
      },
      backward: function(t, s) {
          typeof t === d && (s = t,
          t = e),
          s === e && (s = 1),
          this._currentState.isFirstStep || typeof s !== d || this._move(-s, !0, !1, function(e, s) {
      ...
      destroy: function() {
          var e = this.elements;
          this._trigger("beforeDestroy", null, this.state()) && (this.element.removeClass("wizard"),
      ...
      forward: function(t, s, n) {
          ...
          t = e),
          s === e && (s = 1),
          this._currentState.isLastStep || typeof s !== d || this._move(s, !0, n, function(e, s) {
              this._update(t, this._state(e, s))
          })
      },
      ...
      state: function(s, n, r) {
          return arguments.length ? (t.isArray(s) ? (r = n,
          n = s[1],
          s = s[0]) : t.isArray(n) && (r = n,
          n = e),
          this._state(this.stepIndex(s, n), r)) : this._currentState
      },
      step: function(s, n) {
          if (!arguments.length)
          ...
          s = s[0]);
          var i;
          return typeof s === d ? i = this._find(s, n !== e ? this.steps(n) : this.elements.steps) : (i = this._find(s, this.elements.steps.add(this.elements.branches))) && i.hasClass(r.branch) && (i = this._find(n || 0, this.steps(i))),
          i
      },
      stepIndex: function(s, r, i) {
          ...
          var a;
          return t.isArray(s) ? (i = r,
          r = s[1],
          s = s[0]) : "boolean" == typeof r && (i = r,
          r = e),
          (a = this.step(s, r)) ? (i ? a.siblings(n.step).andSelf() : this.elements.steps).index(a) : -1
      },
      steps: function(t) {
  ...
  t.extend(t.validator, {
      ...
      attributeRules: function(e) {
          ...
          for (var n in t.validator.methods) {
              var a;
              "required" === n ? ("" === (a = s.get(0).getAttribute(n)) && (a = !0),
              a = !!a) : a = s.attr(n),
              ...
              t.ajax(t.extend(!0, {
                  ...
                  success: function(s) {
                      ...
                      if (a) {
                          ...
                          u[i.name] = r.message = t.isFunction(l) ? l(e) : l,
                          n.invalid[i.name] = !0,
                          n.showErrors(u)
                      }
                      r.valid = a,
...
;(function($, window, undefined) {
  ...
  function setTransform(n, t) {
      return n.css("-webkit-transform", "rotate(" + t + "deg)"),
      n.css("-moz-transform", "rotate(" + t + "deg)"),
      n.css("-ms-transform", "rotate(" + t + "deg)"),
      n.css("-o-transform", "rotate(" + t + "deg)"),
  ...
  function RoundSlider(n, t) {
      ...
      this._raise("beforeCreate") !== !1 ? (this._init(),
      this._raise("create")) : this._removeData()
  }
  ...
  RoundSlider.prototype = {
      ...
      _init: function() {
          ...
          typeof n == "string" ? n == "drag" && (this._bindOnDrag = !0) : this._isAngular && (this._bindOnDrag = !0),
          this._onInit()
      },
      _onInit: function() {
          this._initialize(),
      ...
      _initialize: function() {
          this._isBrowserSupport && (this._isReadOnly = !1,
          this._checkDataType(),
          this._refreshCircleShape())
      },
      _render: function() {
          if (this.container = createElement("div.rs-container"),
      ...
      _createLayers: function() {
          ...
          this._rangeSlider || this._showRange ? (this.block1 = n.clone().addClass("rs-range-color").rsRotate(t),
          this.block2 = n.clone().addClass("rs-range-color").css("opacity", "0").rsRotate(t),
          this.block3 = n.clone().addClass("rs-path-color").rsRotate(t),
          this.block4 = n.addClass("rs-path-color").css({
              opacity: "1",
              "z-index": "1"
          }).rsRotate(t - 180),
          this.block.append(this.block1, this.block2, this.block3, this.block4).addClass("rs-split")) : this.block.append(n.addClass("rs-path-color")),
      ...
      _appendTooltip: function() {
          this.container.children(".rs-tooltip").length === 0 && (this.tooltip = createElement("span.rs-tooltip rs-tooltip-text"),
      ...
      _tooltipEditable: function() {
          if (this.tooltip && this.options.showTooltip) {
              var n;
              this.options.editableTooltip ? (this.tooltip.addClass("edit"),
              n = "_bind") : (this.tooltip.removeClass("edit"),
              n = "_unbind"),
      ...
      _focusOut: function(n) {
          n.type == "change" ? (this.options.value = this.input.val().replace("-", ","),
          this._analyzeModelValue(),
          this._validateModelValue(),
          this._setValue(),
          this.input.val(this._getTooltipValue(!0))) : (this.tooltip.addClass("edit").removeClass("hover"),
          this._updateTooltip()),
      ...
      _setRadius: function() {
          ...
          if (this.container.removeClass().addClass("rs-container"),
          n.indexOf("half") === 0) {
              switch (n) {
              case "half-top":
              case "half-bottom":
              ...
              n.indexOf("quarter") === 0 ? (r = u = t,
              f = n.split("-"),
              this.container.addClass(f[0] + " " + f[1] + " " + f[2])) : this.container.addClass("full " + n);
          e = {
              height: r,
              width: u
          },
      ...
      _refreshSeperator: function() {
          var i = this._startLine.add(this._endLine)
            ...
            , f = this._border()
            , t = u + f;
          n.lineCap == "round" && n.circleShape != "full" ? (i.addClass("rs-rounded"),
          r.css({
              width: t,
              height: t / 2 + 1
          }),
          this._startLine.children().css("margin-top", -1).addClass(n.sliderType == "min-range" ? "rs-range-color" : "rs-path-color"),
          this._endLine.children().css("margin-top", t / -2).addClass("rs-path-color")) : (i.removeClass("rs-rounded"),
          r.css({
              width: t,
      ...
      _createHandle: function(n) {
          ...
          r = createElement("div.rs-bar rs-transition").css("z-index", "7").append(t).rsRotate(this._start),
          r.addClass(u.sliderType == "range" && n == 2 ? "rs-second" : "rs-first"),
      ...
      _refreshHandle: function() {
          ...
          if (typeof hSize == "string" && isNumber(hSize))
              if (hSize.charAt(0) === "+" || hSize.charAt(0) === "-")
                  ...
                  hSize.indexOf(",") && (s = hSize.split(","),
                  isNumber(s[0]) && isNumber(s[1]) && (w = parseFloat(s[0]),
                  h = parseFloat(s[1]),
                  isSquare = !1));
      ...
      _activeHandleBar: function(n) {
          return n = n != undefined ? n : this._active,
      ...
      _raiseEvent: function(n) {
          ...
          if (t !== this.options.value)
              return this["_pre" + n] = this.options.value,
              this._updateTooltip(),
              (n == "change" || this._bindOnDrag && n == "drag") && this._updateHidden(),
              this._raise(n, {
      ...
      _elementDown: function(n) {
          ...
          if (!this._isReadOnly)
              ...
              i.hasClass("rs-handle"))
                  ...
                  s >= c && s <= h && (n.preventDefault(),
                  r = this.control.find(".rs-handle.rs-focus"),
                  this.control.attr("tabindex", "0").focus().removeAttr("tabindex"),
                  i.hasClass("rs-seperator") ? (t = i.parent().hasClass("rs-start") ? this.options.min : this.options.max,
                  u = this._valueToAngle(t)) : (f = this._getAngleValue(e, o),
                  u = f.angle,
                  t = f.value),
                  this._rangeSlider && (r = this.control.find(".rs-handle.rs-focus"),
                  this._active = r.length == 1 ? parseFloat(r.attr("index")) : this._handle2.value - t < t - this._handle1.value ? 2 : 1,
      ...
      _handleMove: function(n) {
          n.preventDefault();
          var u = this._getXY(n), f = this._getCenterPoint(), t = this._getAngleValue(u, f, !0), i, r;
          i = t.angle,
          r = t.value,
      ...
      _handleKeyDown: function(n) {
          var t, r, i, u;
          this._isReadOnly || (t = n.keyCode,
          t == 27 && this._handles().blur(),
          t >= 35 && t <= 40) && (t >= 37 && t <= 40 && this._removeAnimation(),
          r = this["_handle" + this._active],
          n.preventDefault(),
          t == 38 || t == 37 ? i = this._round(this._limitValue(r.value + this.options.step)) : t == 39 || t == 40 ? i = this._round(this._limitValue(r.value - this._getMinusStep(r.value))) : t == 36 ? i = this._getKeyValue("Home") : t == 35 && (i = this._getKeyValue("End")),
          u = this._valueToAngle(i),
          this._changeSliderValue(i, u),
          this._raiseEvent("change"))
      },
      ...
      _elementScroll: function(n) {
          if (!this._isReadOnly) {
              ...
              (u = i.wheelDelta ? i.wheelDelta / 60 : i.detail ? -i.detail / 2 : 0,
              u != 0) && (this._updateActiveHandle(n),
              r = this["_handle" + this._active],
              t = r.value + (u > 0 ? this.options.step : -this._getMinusStep(r.value)),
      ...
      _updateActiveHandle: function(n) {
          var t = $(n.target);
          t.hasClass("rs-handle") && t.parent().parent()[0] == this.control[0] && (this.bar = t.parent(),
          this._active = parseFloat(t.attr("index"))),
      ...
      _updateARIA: function(n) {
          ...
          this.options.sliderType == "range" ? (t = this._handles(),
          t.eq(0).attr({
              "aria-valuemin": i
          }),
          t.eq(1).attr({
      ...
      _checkKO: function() {
          var f = this._dataElement().data("bind"), t, i, r, n, u;
          if (typeof f == "string" && typeof ko == "object") {
              if (t = ko.dataFor(this._dataElement()[0]),
              typeof t == "undefined")
                  return !0;
              for (i = f.split(","),
              n = 0; n < i.length; n++)
      ...
      _checkAngular: function() {
          if (typeof angular == "object" && typeof angular.element == "function" && (this._ngName = this._dataElement().attr("ng-model"),
      ...
      _getAngleValue: function(n, t, i) {
          var u = Math.atan2(n.y - t.y, t.x - n.x)
            , r = -u / (Math.PI / 180);
          return r < this._start && (r += 360),
          r = this._checkAngle(r, i),
          this._processStepByAngle(r)
      },
      _checkAngle: function(n, t) {
          var f = this._oriAngle(n), i = this["_handle" + this._active].angle, r = this._oriAngle(i), u;
          if (f > this._end) {
              if (!t)
                  return i;
              n = this._start + (r <= this._end - r ? 0 : this._end)
          } else if (t && (u = this._handleDragDistance,
          isNumber(u) && Math.abs(f - r) > u))
              return i;
          return n
      },
      ...
      _limitAngle: function(n) {
          return n > 360 + this._start && (n -= 360),
          n < this._start && (n += 360),
          n
      },
      _limitValue: function(n) {
          return n < this.options.min && (n = this.options.min),
      ...
      _updateHidden: function() {
          ...
          (this._isKO || this._isAngular) && this._hiddenField.trigger("change"),
      ...
      _validateStartAngle: function() {
          ...
          return n = (isNumber(n) ? parseFloat(n) : 0) % 360,
          n < 0 && (n += 360),
      ...
      _validateEndAngle: function() {
          ...
          return end = (isNumber(end) ? parseFloat(end) : 360) % 360,
          end <= this.options.startAngle && (end += 360),
          end
      },
      _refreshCircleShape: function() {
          var n = this.options.circleShape, i = ["half-top", "half-bottom", "half-left", "half-right", "quarter-top-left", "quarter-top-right", "quarter-bottom-right", "quarter-bottom-left", "pie", "custom-half", "custom-quarter"], t;
          i.indexOf(n) == -1 && (t = ["h1", "h2", "h3", "h4", "q1", "q2", "q3", "q4", "3/4", "ch", "cq"].indexOf(n),
          n = t != -1 ? i[t] : n == "half" ? "half-top" : n == "quarter" ? "quarter-top-left" : "full"),
          this.options.circleShape = n
      },
      _appendOverlay: function() {
          var n = this.options.circleShape;
          n == "pie" ? this._checkOverlay(".rs-overlay", 270) : (n == "custom-half" || n == "custom-quarter") && (this._checkOverlay(".rs-overlay1", 180),
          n == "custom-quarter" && this._checkOverlay(".rs-overlay2", this._end))
      },
      _checkOverlay: function(n, t) {
          var i = this.container.children(n);
          i.length == 0 && (i = createElement("div" + n + " rs-transition rs-bg-color"),
      ...
      _checkDataType: function() {
          ...
          for (r in u.numberType)
              n = u.numberType[r],
              t = i[n],
              i[n] = isNumber(t) ? parseFloat(t) : this.defaults[n];
      ...
      _validateSliderType: function() {
          ...
          n == "range" ? this._rangeSlider = this._showRange = !0 : n.indexOf("min") != -1 ? (this._showRange = !0,
          n = "min-range") : n = "default",
          this.options.sliderType = n
      },
      _updateStartEnd: function() {
          var n = this.options.circleShape;
          n != "full" && (n.indexOf("quarter") != -1 ? this.options.endAngle = "+90" : n.indexOf("half") != -1 ? this.options.endAngle = "+180" : n == "pie" && (this.options.endAngle = "+270"),
          n == "quarter-top-left" || n == "half-top" ? this.options.startAngle = 0 : n == "quarter-top-right" || n == "half-right" ? this.options.startAngle = 90 : n == "quarter-bottom-right" || n == "half-bottom" ? this.options.startAngle = 180 : (n == "quarter-bottom-left" || n == "half-left") && (this.options.startAngle = 270))
      },
      ...
      _analyzeModelValue: function() {
          var n = this.options.value, t = this.options.min, f = this.options.max, u, r, i;
          n instanceof Array && (n = n.toString()),
          i = typeof n == "string" ? n.split(",") : [n],
          this._rangeSlider ? r = typeof n == "string" ? i.length >= 2 ? (isNumber(i[0]) ? i[0] : t) + "," + (isNumber(i[1]) ? i[1] : f) : isNumber(i[0]) ? t + "," + i[0] : t + "," + t : isNumber(n) ? t + "," + n : t + "," + t : typeof n == "string" ? (u = i.pop(),
          r = isNumber(u) ? parseFloat(u) : t) : r = isNumber(n) ? parseFloat(n) : t,
      ...
      _validateModelValue: function() {
          ...
          if (this._rangeSlider) {
              ...
              this["_handle" + i] = this._processStepByValue(this._limitValue(r)),
      ...
      _raise: function(n, t) {
          ...
          $.isFunction(i) && (r = i.call(this, t),
          r = r === !1 ? !1 : r)),
          this.control.trigger($.Event ? $.Event(n, t) : n),
          r
      },
      ...
      _set: function(n, t) {
          ...
          if (this.options[n] != t) {
              ...
              case "circleShape":
                  this._refreshCircleShape(),
                  this.options.circleShape == "full" && (this.options.startAngle = 0,
      ...
      option: function(n, t) {
          if (this._getInstance() && this._isBrowserSupport) {
              if ($isPlainObject(n)) {
                  (n.min !== undefined || n.max !== undefined) && (n.min !== undefined && (this.options.min = n.min,
                  delete n.min),
                  n.max !== undefined && (this.options.max = n.max,
                  delete n.max),
